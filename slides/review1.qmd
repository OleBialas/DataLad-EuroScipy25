...
::: {.notes}
- `datalad clone` is really fast because it only downloads symbolic links
- `datalad get` will actually download the content
- So you can work on very large projects without having to download everythin!
